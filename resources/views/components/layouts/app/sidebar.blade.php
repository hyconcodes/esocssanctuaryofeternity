            ...
            @auth
                @if (auth()->user()?->role === 'admin')
                    <flux:navlist.group :heading="__('Admin')" class="grid">
                        <flux:navlist.item icon="calendar-days" :href="route('admin.events')"
                            :current="request()->routeIs('admin.events')" wire:navigate>{{ __('Manage Events') }}
                        </flux:navlist.item>
                        <flux:navlist.item icon="photo" :href="route('admin.gallery')"
                            :current="request()->routeIs('admin.gallery')" wire:navigate>{{ __('Manage Gallery') }}
                        </flux:navlist.item>
