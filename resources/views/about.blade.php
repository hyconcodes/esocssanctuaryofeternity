...
@section('content')
    <section class="px-4 lg:px-10" data-animate>
        <div class="relative overflow-hidden rounded-2xl shadow-md shadow-purple-200">
    ...
    <section class="px-4 lg:px-10 mt-10 grid gap-6" data-animate>
        ...
        <div class="rounded-2xl p-6 bg-white shadow-md shadow-purple-200">
            ...
            <ul class="mt-3 grid lg:grid-cols-2 gap-3 text-neutral-700">
                <li class="rounded-2xl border p-4">The Bible is God’s inspired Word.</li>
                <li class="rounded-2xl border p-4">Salvation by grace through faith in Jesus Christ.</li>
                <li class="rounded-2xl border p-4">The church as Christ’s body called to unity and service.</li>
                <li class="rounded-2xl border p-4">The Holy Spirit empowers believers for holy living.</li>
            </ul>
        </div>
    </section>
@endsection
