            ...
            <div class="mt-6 grid lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2">
                    <form method="POST" action="#" class="grid gap-3">
                        ...
                        <input type="text" name="phone" placeholder="Phone" class="rounded-2xl border p-3" />
                        <textarea name="message" placeholder="Message" rows="5" class="rounded-2xl border p-3"></textarea>
                ...
                <div class="grid gap-4">
                    <div class="rounded-2xl p-4 border bg-white shadow-md shadow-purple-200">
                    ...
                    <div class="rounded-2xl overflow-hidden border bg-white shadow-md shadow-purple-200">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="rounded-2xl p-2 border hover:bg-[#ffc0cb]">
